        ...
        <div class="mx-auto max-w-content px-4 sm:px-6 mt-3">
            <nav class="flex items-center justify-between gap-4 rounded-2xl bg-sand-50/85 backdrop-blur-md ring-1 ring-navy-900/10 shadow-sm px-4 sm:px-5 h-15 py-2.5">
                ...
                <div class="flex items-center gap-2">
                    <a href="{{ route('portail.magic-link.request') }}" class="hidden sm:inline-flex items-center h-11 px-3.5 rounded-xl text-sm font-semibold text-navy-700 hover:bg-navy-900/5 transition-colors">Espace client</a>
            ...
            >
                <ul class="flex flex-col p-2 text-base font-semibold text-ink-800">
                    ...
                    <li><a href="{{ route('portail.magic-link.request') }}" @click="open = false" class="flex items-center h-12 px-4 rounded-xl bg-azure-500 text-white">Espace client</a></li>
                </ul>
            </nav>
        </div>
    </header>
        ...
        <div class="mx-auto max-w-content px-5 sm:px-8 py-14 grid gap-10 md:grid-cols-[1.4fr_1fr_1fr_auto]">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-navy-200">
                    ...
                    <li><a href="{{ route('portail.magic-link.request') }}" class="hover:text-white transition-colors">Espace client</a></li>
                </ul>
            </div>
