...
**Domain:** Field service / pool maintenance SaaS — Laravel monolith, offline-first mobile PWA, Odoo integration, Stripe billing
**Researched:** 2026-05-27
**Confidence:** HIGH (all versions verified against Packagist/npm/official docs)
...
composer require dompdf/dompdf  # driver par défaut
...
---
*Stack research for: Dlo Azur Piscines — field service pool maintenance*
*Researched: 2026-05-27*
