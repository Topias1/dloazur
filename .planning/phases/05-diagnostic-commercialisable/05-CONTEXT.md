...
- **DIFFÉRÉ V2 (hors Phase 5):** push notifications, carnet offline + courbes, multi-bassins B2B, espace Pierre dashboard, app native/store. Raison : infra de rétention chère qui ne génère pas le 1er lead. Espace Pierre remplacé au départ par WhatsApp.
