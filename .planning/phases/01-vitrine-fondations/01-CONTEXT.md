...
- Configuration Laravel Cloud EU/Francfort + PostgreSQL managé + Scaleway S3 (Paris) wiring
...
- **D-28:** Pas de Google Reviews widget intégré (alourdit la perf). Lien externe vers fiche Google Business à la place.
...
- **`config/filesystems.php`** : disque `s3` configuré pour Scaleway (`endpoint=https://s3.fr-par.scw.cloud`) dès Phase 1, même si la 1re vraie upload arrive en Phase 2.
...
*Decisions amended: 2026-05-28 (D-01, D-05 — see Amendments block above)*
