...
- [x] **DIAG-06**: **Escalade contextualisée en un geste** vers Pierre (WhatsApp pré-rempli : symptôme, mesures, actions tentées, diagnostic, photo) — préemptive (hors-DIY) ou réactive (re-test échoué) ; objectif lead qualifié
